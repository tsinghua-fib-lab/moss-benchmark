...
python3 run_baseline.py --algo rule --data data/us_newyork_s --start 25200 --steps 10800 --exp us_newyork_s --device 0

python3 run_ppo.py --data data/us_newyork_s --start 25200 --steps 10800 --exp us_newyork_s --device 0
