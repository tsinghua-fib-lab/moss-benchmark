...
for city in $PART0_CITIES; do
    ...
    python3 run_baseline.py --algo none --data data/$city --start 25200 --steps 10800 --exp $city --device 3
    
    python3 run_baseline.py --algo random --data data/$city --start 25200 --steps 10800 --exp $city --device 3
