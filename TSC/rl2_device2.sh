...
PART1_CITIES="china_beijing china_shanghai france_paris"

PART2_CITIES="us_newyork china_beijing_s china_shanghai_s"

PART3_CITIES="france_paris_s us_newyork_s china_beijing_c "

PART4_CITIES="china_shanghai_c france_paris_c us_newyork_c"

for city in $PART4_CITIES; do
