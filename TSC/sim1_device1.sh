...
PART1_CITIES="china_beijing china_shanghai france_paris us_newyork china_beijing_s china_shanghai_s"

PART2_CITIES="france_paris_s us_newyork_s china_beijing_c china_shanghai_c france_paris_c us_newyork_c"

for city in $PART1_CITIES $PART2_CITIES; do
